...
ALTER TABLE "products" ADD CONSTRAINT "products_restaurant_is_restaurants_id_fk" FOREIGN KEY ("restaurant_is") REFERENCES "public"."restaurants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "orders_items" ADD CONSTRAINT "orders_items_product_id_users_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;